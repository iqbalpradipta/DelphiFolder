...
begin
  ...
  if (CheckBoxSemangka.Checked = true) and (QtyMangga < 1) then
  begin
  ...
  if (CheckBoxSemangka.Checked = true) and (QtyKlengkeng < 1) then
  begin
    ShowMessage('Input Quantity');
  end;
  ...
  if (CheckBoxAnggur.Checked = true) and (QtyAnggur < 1) then
  begin
    ShowMessage('Input Quantity');
  end;
  ...
  if (CheckBoxJeruk.Checked = true) and (QtyJeruk < 1) then
  begin
    ShowMessage('Input Quantity');
  end;
